(function() {
  ...
  describe('scene controller', function () {
    ...
    it('should not run getScene() if inputEmail is undefined', function () {
      // attempt to pass undefined
      let undefinedID;
      let testEmail = 'davidS@dude.com';

      SceneController.getScene(undefinedID);
      expect(mockSceneService.getScene.numTimesCalled).to.equal(0);
    });
  });
